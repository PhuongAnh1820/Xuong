...
const Header = () => {
    return (
        ...
        <div
          className="w-full bg-[#05422c] lg:h-[37px] mb:h-[34px] *:text-white flex justify-center items-center *:lg:text-sm *:mb:text-xs gap-x-4">
        ...
        <div className="w-full flex justify-center items-center border-b">
          ...
          <div className="container w-[1440px] lg:h-[76px] mb:h-[56px] flex justify-between *:flex *:items-center items-center">
            ...
            <img className="lg:translate-x-[64px] mb:translate-x-[-12.5px] lg:w-[167px] lg:h-[40px] mb:w-[119px] mb:h-[28px]"
